...
class animalesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Opcion::create(["id"=> "350", "ref_campo" => "perros_cuantos", "pregunta_opcion" => "numero", "valor" => "0"]);
        Opcion::create(["id"=> "351", "ref_campo" => "perros_vacunados", "pregunta_opcion" => "numero", "valor" => "0"]);
        ...
        Opcion::create(["id"=> "354", "ref_campo" => "equinos_cuantos", "pregunta_opcion" => "numero", "valor" => "0"]);
        Opcion::create(["id"=> "355", "ref_campo" => "equinos_vacunados", "pregunta_opcion" => "numero", "valor" => "0"]);
        ...
        Opcion::create(["id"=> "360", "ref_campo" => "porcinos_cuantos", "pregunta_opcion" => "numero", "valor" => "0"]);
        Opcion::create(["id"=> "361", "ref_campo" => "porcinos_vacunados", "pregunta_opcion" => "numero", "valor" => "0"]);
