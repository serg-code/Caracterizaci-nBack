...
class CuidadoEnfermedadesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Pregunta::create(["ref_campo" => "parejas_sexuales_año", "ref_seccion" => "cuidado_enfermedades", "descripcion" => "¿Ha tenido mas de una pareja sexual el ultimo año?", "tipo" => "numero"]);
