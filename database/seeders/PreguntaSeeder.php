...
class PreguntaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Pregunta::guardarPregunta(["ref_campo" => "duermen_ninos_ninas_adultos", "ref_seccion" => "factore_protectores", "descripcion" => "¿Duermen los ninos y ninas separados de los adultos?", "tipo" => "selección"]);
        ...
        Pregunta::guardarPregunta(["ref_campo" => "relaciones_cordiales_respetuosas", "ref_seccion" => "factore_protectores ", "descripcion" => "Relaciones cordiales y respetuosas", "tipo" => "selección"]);
        ...
        Pregunta::guardarPregunta(["ref_campo" => "secretaria_fumigado", "ref_seccion" => "factore_protectores ", "descripcion" => "¿En el último ano la secretarìa ha fumigado?", "tipo" => "selección"]);
