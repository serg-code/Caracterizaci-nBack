...
class accidenteseeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Opcion::create(["id" => "70", "ref_campo" => "tipo_lesión", "pregunta_opcion" => "Sin lesión", "valor" => "0"]);
        Opcion::create(["id" => "71", "ref_campo" => "tipo_lesión", "pregunta_opcion" => "Fractura", "valor" => "3"]);
        Opcion::create(["id" => "72", "ref_campo" => "tipo_lesión", "pregunta_opcion" => "Trauma de tejido blando", "valor" => "3"]);
        Opcion::create(["id" => "73", "ref_campo" => "tipo_lesión", "pregunta_opcion" => "Daño neurologíco", "valor" => "5"]);
        Opcion::create(["id" => "74", "ref_campo" => "tipo_lesión", "pregunta_opcion" => "Discapacidad", "valor" => "10"]);
