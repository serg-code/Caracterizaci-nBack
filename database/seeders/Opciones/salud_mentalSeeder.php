...
use App\Models\model\salud_mental;
...
class salud_mentalSeeder extends Seeder
{
    ...
    public function run()
    {
        Opcion::create(["id"=> "92", "ref_campo" =>  "depresión", "pregunta_opcion" => "SI", "valor" => "1"]);
        Opcion::create(["id"=> "92", "ref_campo" =>  "depresión", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::create(["id"=> "93", "ref_campo" =>  "intentosuicidio", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::create(["id"=> "94", "ref_campo" =>  "intentosuicidio", "pregunta_opcion" => "SI", "valor" => "3"]);
