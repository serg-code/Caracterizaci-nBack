...
class OpcionesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Opcion::guardarOpcion(["id" => "5", "ref_campo" => "duermen_ninos_ninas_adultos", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "6", "ref_campo" => "problemas_alcohol", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "7", "ref_campo" => "problemas_alcohol", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "8", "ref_campo" => "consume_tranquilizantes", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "9", "ref_campo" => "consume_tranquilizantes", "pregunta_opcion" => "SI", "valor" => "3"]);
        ...
        Opcion::guardarOpcion(["id" => "20", "ref_campo" => "fumigar_vivienda", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "21", "ref_campo" => "secretaria_fumigado", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "22", "ref_campo" => "secretaria_fumigado", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "23", "ref_campo" => "acido_borico_cucarachas", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "24", "ref_campo" => "acido_borico_cucarachas", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "25", "ref_campo" => "consumo_huevos_crudos", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "26", "ref_campo" => "consumo_huevos_crudos", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "27", "ref_campo" => "alimentos_perecederos", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "28", "ref_campo" => "alimentos_perecederos", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "29", "ref_campo" => "Hierve_leche", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "30", "ref_campo" => "Hierve_leche", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "31", "ref_campo" => "lavar_frutas_verduras", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "32", "ref_campo" => "lavar_frutas_verduras", "pregunta_opcion" => "SI", "valor" => "3"]);
        Opcion::guardarOpcion(["id" => "33", "ref_campo" => "alimentos_crudos_separados_cocidos", "pregunta_opcion" => "NO", "valor" => "1"]);
        Opcion::guardarOpcion(["id" => "34", "ref_campo" => "alimentos_crudos_separados_cocidos", "pregunta_opcion" => "SI", "valor" => "3"]);
    }
}