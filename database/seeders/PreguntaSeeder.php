...
class PreguntaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Pregunta::guardarPregunta(["ref_campo" => "secretaría_fumigado", "ref_seccion" => "factore_protectores ", "descripcion" => "¿En el último ano la secretarìa ha fumigado?", "tipo" => "selección"]);
